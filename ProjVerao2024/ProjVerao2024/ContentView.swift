...
struct ContentView: View {
    ...
    @FetchRequest ( sortDescriptors: [NSSortDescriptor(keyPath: \Food.date, ascending: true)], animation: .default ) var food: FetchedResults<Food>
        ...
        NavigationView{
            VStack{
                ...
                List{
                    ...
                    ForEach<FetchedResults<Food>, UUID?, Any>(food) { foodElement in
